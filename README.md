...
* Xây dựng API lấy danh sách các rating
...
Lab 5 tập trung kết nối **frontend ReactJS** với **backend API** cho ứng dụng **Movie Reviews**.

Các nội dung chính thực hiện:

* Cài đặt **Axios** cho dự án React
* Tạo lớp dịch vụ **MovieDataService**
* Xây dựng các lời gọi API tới backend
* Xây dựng **MoviesList Component**
* Tìm kiếm movie theo title
* Tìm kiếm movie theo rating
* Hiển thị thông tin chi tiết của movie
* Hiển thị danh sách review tương ứng cho từng movie
...
5. Cài đặt các thư viện cần thiết: `npm install`
